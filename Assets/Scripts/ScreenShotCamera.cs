...
public class ScreenShotCamera : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(screenShotKey))
        {
            ...
            ScreenCapture.CaptureScreenshot(System.IO.Path.Combine(folderPath, screenshotName), resolutionScale); // takes the sceenshot, the "2" is for the scaled resolution, you can put this to 600 but it will take really long to scale the image up
